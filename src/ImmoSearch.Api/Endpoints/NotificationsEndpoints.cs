...
public static class NotificationsEndpoints
{
    ...
    {
        app.MapPost("/notifications/webpush/subscribe", async (
        ...
        app.MapPost("/notifications/webpush/test", async (
            IWebPushSubscriptionRepository repository,
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            {
                await sender.SendAsync(sub, "ImmoSearch Test", "Test notification", null,
                    cancellationToken);
            }
        ...
        app.MapDelete("/notifications/webpush/subscribe/{endpoint}", async (
            IWebPushSubscriptionRepository repository,
            string endpoint,
            CancellationToken cancellationToken) =>
        {
            ...
            {
                return Results.BadRequest("Missing endpoint");
            }

            await repository.RemoveAsync(Uri.UnescapeDataString(endpoint), cancellationToken);
            return Results.Ok();
